...
1. **Router node** — calls `ChatAnthropic.withStructuredOutput` to classify user text into `music | lists | climate | weather | locks | lights | states | maintenance | gaming | help`. No HA calls are made here.
